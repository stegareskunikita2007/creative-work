...
void MonitoringWorker::processLongPollResponse(const QJsonObject &data)
{
    ...
    for (const QJsonValue &update : updates) {
        ...
        QStringList helpMarkers = {
            // Основные
            "помогите", "помоги", "помочь",
            "объясните", "объясни", "объяснить",
            "не понимаю", "не понимать", "не пойму",
            "сложно", "сложна", "сложный",
            "не могу", "не можешь", "не может",
            "запутался", "запуталась", "запутались",

            // Просьбы о помощи
            "нужна помощь", "нужен совет", "нужна подсказка",
            "выручайте", "выручи", "выручить",
            "подскажите", "подскажи", "подсказать",
            "расскажите", "расскажи",
            "научите", "научи",
            "посоветуйте", "посоветуй",

            // Разговорные
            "кто знает", "кто шарит", "кто разбирается", "кто в теме",
            "не получается", "не выходит", "не идёт",
            "не работает", "не компилируется", "не запускается",
            "не знаю", "не знать",
            "трудно", "тяжело", "непонятно", "непонятна",
            "хелп", "help", "спасите", "спасайте",
            "беда", "проблема", "не справляюсь",
            "плиз", "плез", "памагите", "памаги"
        };
